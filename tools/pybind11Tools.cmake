...
#
function(pybind11_add_module_shared target_name)
...
function(pybind11_add_module_ext target_name)
  set(options MODULE SHARED EXCLUDE_FROM_ALL NO_EXTRAS SYSTEM THIN_LTO)
  cmake_parse_arguments(ARG "${options}" "" "" ${ARGN})
  ...
  elseif(ARG_SHARED)
    ...
    set(lib_type MODULE)
    set(binding_type pybind11:module)
  endif()
  if(ARG_EXCLUDE_FROM_ALL)
    set(exclude_from_all EXCLUDE_FROM_ALL)
  endif()
  ...
  if(WIN32 OR CYGWIN)
    # Link against the Python shared library on Windows
    target_link_libraries(${target_name} PRIVATE ${PYTHON_LIBRARIES} ${binding_type})
  elseif(APPLE)
    # It's quite common to have multiple copies of the same Python version
    # installed on one's system. E.g.: one copy from the OS and another copy
    # that's statically linked into an application like Blender or Maya.
    ...
    target_link_libraries(${target_name} PRIVATE "-undefined dynamic_lookup" ${binding_type})
